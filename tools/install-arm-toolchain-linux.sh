...
TOOLCHAIN_URL="https://developer.arm.com/-/media/Files/downloads/gnu/14.2.rel1/binrel/arm-gnu-toolchain-14.2.rel1-x86_64-arm-none-linux-gnueabihf.tar.xz"
#INSTALL_DIR="/opt/arm-gnu-toolchain-14.2.rel1-linux"
INSTALL_DIR="/opt/arm-gnu-toolchain-14.2.rel1-linux-gnueabihf"
PROFILE_FILE="$HOME/.bashrc"
TEMP_DIR="/tmp/arm-toolchain-linux"
